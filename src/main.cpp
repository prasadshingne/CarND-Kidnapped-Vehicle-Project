    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // std::cout << " delta_t " << "best_particle_x " << ""best_particle_y " << "best_particle_theta " << std::endl;

          std::cout << delta_t << " " << best_particle.x << " " << best_particle.y << " " << best_particle.theta << std::endl;
